...
//printInfo(ABSPATH.WPINC);
//printInfo(ABSPATH.WPINC);
require ABSPATH . WPINC . '/formatting.php';// problem started here
...
//printInfo('we are here now ');
require ABSPATH . WPINC . '/class-wp-query.php'; // problem file
